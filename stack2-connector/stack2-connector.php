...
require_once STACK2_CONNECTOR_PATH . 'includes/class-stack2-restore-script-store.php';
require_once STACK2_CONNECTOR_PATH . 'includes/class-stack2-restore-api.php';
